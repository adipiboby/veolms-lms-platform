  ...
  const handleLessonVideoMeta = (sectionIndex, lessonIndex, metadata) => {
    setFormData((prev) => {
      ...
      lessons[lessonIndex] = {
        ...
        videoAssetId: metadata.videoAssetId || currentLesson.videoAssetId || "",
      };
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-white md:px-8">
      <div className="mx-auto max-w-[1500px]">
        <div className="mb-10">
          <p className="mb-3 font-bold text-blue-400">Create Course</p>

          <h1 className="text-4xl font-black md:text-5xl">New Course</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <h2 className="mb-6 text-2xl font-black">Course Information</h2>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none placeholder:text-slate-500 focus:border-blue-500"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleCourseChange}
                  className="w-full rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500"
                >
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full resize-none rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none placeholder:text-slate-500 focus:border-blue-500"
                ...
                >
                  ...
                  <div className="mb-5 grid gap-4 md:grid-cols-[1fr_160px]">
                    <input
                      ...
                      required
                      className="rounded-2xl border border-white/10 bg-slate-900 px-4 py-3 text-white outline-none placeholder:text-slate-500 focus:border-blue-500"
                          ...
                          <div className="space-y-4">
                            ...
                            {(lesson.duration ||
                              ...
                              <div className="rounded-2xl border border-blue-500/20 bg-blue-500/10 p-4">
                                <p className="mb-2 flex items-center gap-2 text-sm font-bold text-blue-200">
                                  <FileVideo size={16} />
                                  Video Details
                                </p>
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 font-bold text-white hover:bg-white/15"
                  >
                    <Plus size={18} />
                    Add Lesson
                  </button>
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3 font-black text-white disabled:opacity-60"
            >
